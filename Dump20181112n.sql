...
--
-- Dumping routines for database 'elliprojekt'
--
/*!50003 DROP PROCEDURE IF EXISTS `GetAllCateg` */;
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `GetAllCateg`()
BEGIN
SELECT *
FROM `groups`;
END ;;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `getProductsForCat` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `getProductsForCat`(IN cat int8)
BEGIN
	SELECT *
FROM group_products
JOIN products
ON group_products.product_id = products.id
WHERE group_id = cat;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
...
-- Dump completed on 2018-11-12 19:35:01
